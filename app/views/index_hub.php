    ...
    <header class="sticky top-0 z-40 bg-slate-900/90 backdrop-blur border-b border-slate-800 shadow-md">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <!-- Thêm vào thanh Menu chính của trang chủ cũ -->
				<nav class="main-menu">
				    <ul>
				        <!-- Nút vào Khóa học mới (đưa lên đầu Menu) -->
				        <li class="highlight-course">
				            <a href="index.php?action=courses&lang=<?= urlencode($current_lang ?? 'en') ?>" style="background: #0284c7; color: white; padding: 8px 15px; border-radius: 6px; font-weight: bold; text-decoration: none;">
				                🎓 Khóa học Language (<?= strtoupper($current_lang ?? 'EN') ?>)
				            </a>
				        </li>
				    </ul>
				</nav>
